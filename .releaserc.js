  ...
  plugins: [
    ...
    [
      ...
      "@semantic-release/exec",
      {
        ...
        publishCmd:
          "ansible-galaxy collection publish mcowser_p-presto_deployo-${nextRelease.version}.tar.gz --token $GALAXY_API_KEY",
      },
    ],
    [
      "@semantic-release/github",
      {
        ...
        assets: [
          { path: "mcowser_p-presto_deployo-*.tar.gz", label: "Ansible collection (mcowser_p.presto_deployo)" },
        ],
      },
    ],
  ],
